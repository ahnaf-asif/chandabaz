...
export const get_union_by_id = (id: string) => {
  return ALL_UNIONS.find((union) => union.id === id);
};

export const get_union_by_name = (name: string) => {
  return ALL_UNIONS.find((union) => union.name === name);
};

export const get_union_by_bn_name = (bn_name: string) => {
  return ALL_UNIONS.find((union) => union.bn_name === bn_name);
};

export const get_union_by_upazilla_id = (upazila_id: string) => {
  return ALL_UNIONS.find((union) => union.upazila_id === upazila_id);
};
