export const ALL_UPAZILLAS = [
  ...
  },
  {
    ...
    name: 'Shantiganj',
    bn_name: 'শান্তিগঞ্জ',
    url: 'shantiganj.sunamganj.gov.bd',
  },
  {
    id: '302',
    district_id: '39',
  ...
  },
  {
    ...
    name: 'Madhyanagar',
    bn_name: 'মধ্যনগর',
    url: 'madhyanagar.sunamganj.gov.bd',
  },
  {
    id: '494',
    district_id: '50',
  ...
  },
  {
    ...
    url: 'shayestaganj.habiganj.gov.bd',
  },
];

export const get_upazilla_by_id = (id: string) => {
  return ALL_UPAZILLAS.find((upazilla) => upazilla.id === id);
};

export const get_upazilla_by_name = (name: string) => {
  return ALL_UPAZILLAS.find((upazilla) => upazilla.name === name);
};

export const get_upazilla_by_bn_name = (bn_name: string) => {
  return ALL_UPAZILLAS.find((upazilla) => upazilla.bn_name === bn_name);
};

export const get_upazillas_by_district_id = (district_id: string) => {
  return ALL_UPAZILLAS.filter((upazilla) => upazilla.district_id === district_id);
};
